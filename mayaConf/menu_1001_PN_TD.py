#!/usr/bin/env python
# -*- coding:UTF-8 -*-
# @Time     : 2019/5/14 11:36
# @Email    : spirit_az@foxmail.com
# @Name     : menu_1001_PN_TD.py
...
def initMenu():
    ...
    # - main menu
    cmds.menu(l='1001_PN_TD', to=True, p=mayaWin)

    # General +--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+-- #
    cmds.menuItem(l='General', i='general.png', sm=True, to=True)
    cmds.menuItem(d=True)
    cmds.menuItem(l='Pipeline tools', c='from CGTmW.Pipeline_tools import openUI;reload(openUI);openUI.show("cgtw", "1001_PN_TD")')
