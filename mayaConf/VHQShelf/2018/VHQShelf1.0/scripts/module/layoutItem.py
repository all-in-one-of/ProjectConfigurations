...
class addItem(__init__.add_item):
    ...
    def run(self):
        ...
        cmds.menuItem(l='change plane', c='from GNR.PlaneEdit import layout;reload(layout);layout.run()', p=self.popupMenu)
        ...
        cmds.menuItem(l='help', i='cloud_download.png', c='print "This is layout tools"', p=self.popupMenu)
