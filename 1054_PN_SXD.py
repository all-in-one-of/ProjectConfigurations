...
CLARISSE_CONF_PATH = os.path.join(os.path.dirname(basePath), 'Clarisse', CLARISSE_VERSION).replace('\\', '/')
...
MAYA_BAT_PATH = dict(XBMLANGPATH=['{0}/Maya/icons/{1}'.format(PROJECT_MAYA_PATH, MAYA_VERSION),
                     ...
                     MAYA_MODULE_PATH=["{0}/mayaConf/VHQShelf/{1}/VHQShelf1.0".format(basePath, MAYA_VERSION),
                                       "{0}/Maya/modules/Yeti/{1}/Yeti3.1.9".format(PROJECT_MAYA_PATH, MAYA_VERSION),
                                       "{0}/Maya/modules/mtoa/{1}/mtoa3.1.2.1".format(PROJECT_MAYA_PATH, MAYA_VERSION),
